...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Boeing737Sample_updatedCopy_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PowerFlowLib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Boeing737Sample_updatedCopy_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_PowerFlowLib_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Boeing737Sample_updatedCopy_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PowerFlowLib_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Boeing737Sample_updatedCopy") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Boeing737Sample_updatedCopy_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }

  if (strcmp(machineName, "PowerFlowLib") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PowerFlowLib_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Boeing737Sample_updatedCopy_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PowerFlowLib_third_party_uses_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Boeing737Sample_updatedCopy") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Boeing737Sample_updatedCopy_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
  ...
  if (strcmp(machineName, "PowerFlowLib") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_PowerFlowLib_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Boeing737Sample_updatedCopy_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_PowerFlowLib_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "Boeing737Sample_updatedCopy") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Boeing737Sample_updatedCopy_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "PowerFlowLib") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_PowerFlowLib_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_Boeing737Sample_updatedCopy_method_dispatcher(SimStruct
  *S, unsigned int chartFileNumber, const char* specsCksum, int_T method, void
  *data);
extern unsigned int sf_PowerFlowLib_method_dispatcher(SimStruct *S, unsigned int
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Boeing737Sample_updatedCopy")) {
    return(sf_Boeing737Sample_updatedCopy_method_dispatcher(simstructPtr,
            chartFileNumber,specsCksum,method,data));
  }

  if (!strcmp(machineName,"PowerFlowLib")) {
    return(sf_PowerFlowLib_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void Boeing737Sample_updatedCopy_terminator(void);
extern void PowerFlowLib_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Boeing737Sample_updatedCopy_terminator();
    PowerFlowLib_terminator();
...
extern void Boeing737Sample_updatedCopy_initializer(void);
extern void PowerFlowLib_initializer(void);
extern void Boeing737Sample_updatedCopy_register_exported_symbols(SimStruct* S);
extern void PowerFlowLib_register_exported_symbols(SimStruct* S);
extern void Boeing737Sample_updatedCopy_debug_initialize(struct
  SfDebugInstanceStruct*);
extern void PowerFlowLib_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Boeing737Sample_updatedCopy_register_exported_symbols(S);
  PowerFlowLib_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Boeing737Sample_updatedCopy_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    Boeing737Sample_updatedCopy_initializer();
    if (!simModeIsRTWGen) {
      PowerFlowLib_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    PowerFlowLib_initializer();
  }
