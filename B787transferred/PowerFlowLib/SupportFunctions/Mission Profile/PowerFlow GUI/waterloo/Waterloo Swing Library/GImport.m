classdef GImport < handle
    ...
    %     With GImport, you can design Java-based GUIs using Java and place
    %     the GUIs in MATLAB figures.
    ...
    %
    %     Convenenence methods are included to support dynamically setting 
    %     common properties across a hierarchy of components, e.g. Fonts and
    %     Background colors and for drag & drop between components.
    %
    %     Methods are also included to support user interaction and control
    %     the MATLAB thread via 'Cancel' and 'OK' buttons.
    %
    ...
    %                           should be function handle. This will be
    ...
    methods
        ...
        function setCentral(obj)
            ...
            pos=getpixelposition(obj.Parent);
            xcenter=ppos(1)+(ppos(3)-ppos(1))/2;
            ycenter=ppos(2)+(ppos(4)-ppos(2))/2;
