classdef MUtilities
    % MUtilities  - MATLAB utilities for R2006b onwards
    %
    ...
    %
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % THIS IS VERSION 2 AND IS RECOMMENDED FOR MATLAB R2006b through R2007b
    % It will also work with later MATLAB versions
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %
    % Windows/Linux
    % For R2006a through R2007b, MATLAB shipped with JRE 1.5. Not all
    % functionality in MUtilities will be available. You can upgrade to JRE
    % 1.6.10 or later to get full functionality, but this will have knock-on
    % effects elsewhere in MATLAB. JRE 1.6 is not officially supported by
    % TMW with these MATLAB versions.
    ...
    %
    %
    % The Java code used within MUtilities can be downloaded from
    ...
    % To use any functions dependent on AWTUtilities, JRE 1.6.10 or higher
    % must be in use (see the README.TXT file for details).
    %
    %
    ...
    %
    % Note that the Look and Feel methods are experimental.
    %
    % ACKNOWLEDGEMENT:
