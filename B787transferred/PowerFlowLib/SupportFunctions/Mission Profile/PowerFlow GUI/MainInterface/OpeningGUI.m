...
% Last Modified by GUIDE v2.5 12-Oct-2015 17:49:23
...
MSSNMain
close OpeningGUI
% --- Executes on button press in walkthrough.
function walkthrough_Callback(hObject, eventdata, handles)
% hObject    handle to walkthrough (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
BatchSingleLoad
close OpeningGUI
