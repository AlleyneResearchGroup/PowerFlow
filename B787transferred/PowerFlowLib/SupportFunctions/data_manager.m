...
%      signals in the PowerFlow toolset.  Data sink blocks
%
...
% Last Modified by Matt Williams 15-Apr-2014 
...
if ~isempty(ff)     % if not empty
    for i = 1:length(ff)
        ...
        handles.var_ind(i,1) = hblock.UserData{1,2};    % variable index for the signal
    end
