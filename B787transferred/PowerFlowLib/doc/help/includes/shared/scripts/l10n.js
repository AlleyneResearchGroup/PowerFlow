...
function StringMap() {
    this.strings = {
        ...
        ko_KR: {
            click_to_collapse:'축소 하려면 클릭 하십시오',
            click_to_expand:'확장 하려면 클릭 하십시오',
            back_to_top_of_page:'페이지 맨 위로 돌아가기',
            back_to_top_of_section:'맨 위로 돌아가기',
            yes:'예',
            no:'아니',
            was_this_topic_helpful:'이 항목에서는 도움이 되었습니까?',
            expand_all:'모두 확장',
            collapse_all:'모두 축소',
            play:'재생하다',
            stop:'중지',
    ...
    // This is a workaround for matching instances in our
    // code where the locale for a certain language returns
    // a two character long string.
