...
% Last Modified by GUIDE v2.5 12-Oct-2015 18:13:17
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure wither choose ith handles and user data (see GUIDATA)
msgbox('You can either choose to Build Batch or load previuosly built batch. Once the batch has been built you can either save or view the batch. Choose the parameters you would like to view.');
